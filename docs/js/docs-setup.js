NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "shortName": "GridOptions",
      "type": "object",
      "keywords": "allows api are available be class column contain counts enable enablegroupheaderselection enablegrouping entire false feature for grid gridoptions group grouped groupheader grouping groupingnulllabel groupingshowcounts header in label null object on or row rows selected set shows string the these to true ui ui-grid undefined use using value which"
    },
    {
      "section": "api",
