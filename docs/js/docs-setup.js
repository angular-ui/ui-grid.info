NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "shortName": "PublicApi",
      "type": "object",
      "keywords": "again aggregatearray aggregation aggregations all an and api apply array be by call children collapse collapseallrows collapsed collapserow colname column config configuration contains currently expand expandallrows expanded expandedstate expandrow expandrowchildren expands feature field for format function get getexpanded getgrouping grandchildren grid grouparray grouped grouping grouppriority hash if immediate in is it name nodes not object objects of or out provided public return returned row rows savestate set setgrouping sorted specified state the this to toggle togglerowgroupingstate ui used want when where whether will wish you"
    },
    {
      "section": "api",
