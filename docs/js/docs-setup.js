NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "shortName": "PublicApi",
      "type": "object",
      "keywords": "$scope act and api array available brings broadcast can cell cellnav coldef column current data does events feature focus focused for from function getfocusedcell grid gridapi gridoptions has have if instance into is last like make no not null object occurred public returns row rowentity scope scrollto scrolltofocus selection set sets specified that the to ui upon usually value view visible we you"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "type": "overview",
      "keywords": "$http $log $scope add address age allowcellfocus an and angular api app back balance btn btn-success button callback cell cellnav city class col coldef colindex column columndefs company controller css current currentfocused data directive displayname element email enable entity event example false focus focusable focused for function get getcurrentfocus getfocusedcell grid gridapi gridoptions guid height html id if include index info is js json log main mainctrl module msg must name navigate navigated navigation new newrowcol ng-bind ng-click ng-controller ngtouch null of old oldrowcol on on_cellnav onregisterapi or overview page phone pinning position programatically provides register remembering requesting returns row rowcol rowindex scroll scrolling scrollto scrolltofocus setting specific state success that the this to tojson tutorial type ui ui-grid ui-grid-cellnav ui-grid-pinning useful user uses using var when width you your"
    },
    {
      "section": "tutorial",
      "id": "203_pinning",
