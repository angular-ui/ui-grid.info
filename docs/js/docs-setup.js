NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "shortName": "GridOptions",
      "type": "object",
      "keywords": "always and api are at available be but class come deep each enable enablegrouping entire even false feature for forces go grid gridoptions group grouped groupheader grouping groupingindent groupingrowheaderalwaysvisible groupingrowheaderwidth grouprowheader having header icon if in increase indent indents is level make may more need nested nothing number object of pixels pleasing preferable present result row set situations some the these this to too true ui ui-grid using visually wider width you your"
    },
    {
      "section": "api",
