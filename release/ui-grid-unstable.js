        ...
        function ($log, $q, $templateCache, uiGridSelectionConstants, gridUtil) {
            ...
            var service = {
                ...
                shiftSelect: function(grid,row,multiSelect) {
                    ...
                    var fromRow = selectedRows.length > 0 ?  grid.renderContainers.body.visibleRowCache.indexOf(grid.lastSelectedRow) : 0;
                    ...
                    for (var i = fromRow; i <= toRow; i++) {
                        ...
                        if (rowToSelect) {
                            ...
                            grid.lastSelectedRow = rowToSelect;
